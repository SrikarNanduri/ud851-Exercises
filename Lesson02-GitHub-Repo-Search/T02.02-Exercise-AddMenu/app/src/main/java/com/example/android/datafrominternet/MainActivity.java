    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case  R.id.action_search:
                String search_message ="Search Clicked...!!! ";
                Toast.makeText(this, search_message, Toast.LENGTH_LONG).show();
                return true;

            case R.id.action_share:
                String share_message ="Share Clicked...!!! ";
                Toast.makeText(this, share_message, Toast.LENGTH_LONG).show();
                return true;

            case R.id.action_print:
                String print_message ="Print Clicked...!!! ";
                Toast.makeText(this, print_message, Toast.LENGTH_LONG).show();
                return true;
